...
async function deleteStoryController(req,res) {
    ...
    try {
        ...
        const imageKey = travelStory.imageUrl
...
module.exports = {createStoryController,getTravelStoryController,uploadImageController,deleteingImageController,updateStoryController,deleteStoryController,updateFavouriteController,searchStoryController,storyByDateController}